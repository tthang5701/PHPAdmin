					...
					<tbody>
						...
						?>
								<tr>
									...
									<td>
										<button type="button" class="btn btn-success editBtn" id="editBtn" value="<?php echo $row['idsanpham']; ?>"> EDIT</button>
									</td>
									<td>
										...
										<button type="button" class="btn btn-danger deleteBtn" 
											id="deleteBtn" value="<?php echo $row['idsanpham']; ?>"> DELETE</button>
									</td>
								</tr>
						<?php
							}
